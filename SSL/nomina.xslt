...
<xs:annotation>
<xs:documentation>
Nodo para expresar la información detallada de un ingreso
</xs:documentation>
</xs:annotation>
<xs:complexType>
...
<xs:annotation>
<xs:documentation>
Atributo requerido para la descripción de un tipo de ingreso conforme al catálogo actual del DIMM
</xs:documentation>
</xs:annotation>
<xs:simpleType>
...
<xs:annotation>
<xs:documentation>
Atributo requerido, representa la clave de ingreso de nómina propia de la contabilidad de cada patrón, puede conformarse desde 3 hasta 15 caracteres
</xs:documentation>
</xs:annotation>
<xs:simpleType>
...
<xs:annotation>
<xs:documentation>
Atributo requerido para la descripción del concepto de ingreso
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:string">
...
<xs:annotation>
<xs:documentation>
Nodo para expresar la información detallada de un descuento
</xs:documentation>
</xs:annotation>
<xs:complexType>
...
<xs:annotation>
<xs:documentation>
Atributo requerido para la descripción del tipo de descuento conforme al catálogo actual del DIMM
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:int">
...
<xs:annotation>
<xs:documentation>
Atributo requerido para la clave de descuento de nómina propia de la contabilidad de cada patrón, puede conformarse desde 3 hasta 15 caracteres
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:string">
...
<xs:annotation>
<xs:documentation>
Atributo requerido para la descripción del concepto de descuento
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:string">
...
<xs:annotation>
<xs:documentation>
Atributo requerido para expresar el registro patronal a 20 posiciones máximo
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:string">
...
<xs:annotation>
<xs:documentation>
Atributo requerido para la expresión del tipo de régimen por el cual se tiene contratado al trabajador Este tiene dos posibles valores: “Asimilados a salarios” o “Sueldos y salarios”
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:string">
...
<xs:annotation>
<xs:documentation>
Atributo opcional para la expresión del número de días pagados
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:int">
...
<xs:annotation>
<xs:documentation>
Atributo opcional para la expresión del Banco conforme al catalógo, donde se realiza un depósito de nómina
</xs:documentation>
</xs:annotation>
<xs:simpleType>
<xs:restriction base="xs:int">
